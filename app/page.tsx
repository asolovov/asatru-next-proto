        ...
        <main className={styles.main}>
            ...
            <div className={styles.mainText}>
                <p>Корни этой религии лежат в представлениях германских племён эпохи Переселения
                    ...
                    XII-XIV веков: в поэмах «<Link target={"_blank"} className={styles.link}
                                                   href={"https://norroen.info/src/edda/"}>Старшей
                        Эдды</Link>»,
                    «<Link target={"_blank"} className={styles.link} href={"https://norroen.info/src/snorra/"}>Младшей
                        Эдды</Link>»
                    исландца <Link target={"_blank"} className={styles.link}
                                   href={"https://norroen.info/src/snorra/litmon/stk.html"}>Снорри
                        Стурлусона</Link>
                    , <Link target={"_blank"} className={styles.link} href={"https://norroen.info/src/abc.html"}>исландских
                        сагах</Link> и
                    стихотворениях скальдов. Поэтому в Асатру
                    используется в основном <b>древнескандинавская</b> терминология, также встречается
                    использование <b>древнего готского</b> и <b>прагерманского</b> языков.
                    ...
                    «Старшая Эдда» и «Младшая Эдда» являются наиболее авторитетными, но не
            ...
            <div className={styles.mainText}>
                ...
                <p>В том же 1973 году Стивен Макналлен основывал Свободное Собрание Асатру в США. В
                    1980 г. известный исследователь Эдред Торссон основывал международную организацию
                    «Рунная Гильдия». В 1988 году в США создается «The Troth» (Трот), ныне
                    представляющая собой значительное и разветвлённое объединение. В период с 1994 по
                    1999 год организации Асатру возникают в скандинавских странах.</p>
            ...
            <div className={styles.mainText}>
                ...
                <p>Основными богами являются глава асов и бог мудрости, войны и
                    вдохновения <Link
                        target={"_blank"}
                        className={styles.link}
                    ...
                    лучник Улль и т.д. </p>
                <p>Поскольку понятие «ас» (Ás) является не только названием группы богов-асов, но и
                    используется в источниках в значении «бог», выделение почитания одного или группы сверхъестественных
                    существ (отдельно
                    ванов или отдельно ётунов и т.д.) тоже попадает под определение Асатру в широком
                ...
                <p>Последователи Асатру верят в создание Вселенной как результата взаимодействия
                    огненного и ледяного начал, и в создание известного людям мира из тела
                    Первосущества <Link
                        target={"_blank"}
                        className={styles.link}
                    ...
                    судьбы – норны, и их приговор непреложен. Судьба мироздания, в целом,
                    предопределена, и известный нам мир погибнет при Рагнарёке, Последней битве богов с хтоническими
                    чудовищами.
                    В этой битве погибнет глава богов Один, боги Тор, Тюр, Хеймдалль, Фрейр. Однако их жертва и борьба
                    спутников Одина — эйнхериев — позволит миру и людям в нём возродиться для нового Золотого Века (с
                    которого некогда началась история богов).</p>
                <p>Вера в посмертие в Асатру не является определяющей частью веры, но, в целом,
                    считается, что достойно павшие в бою отправляются в чертог Одина — Вальхаллу, верные тому или иному
                    богу могут попасть в его жилище, те
                    же, кто не был удостоен выбора богов, отправляются во владения ётунши Хель, поставленной
                    Одином хранить мир мёртвых. Также в Асатру признаётся возможность возрождения
            ...
            <div className={styles.mainText}>
                ...
                <p>Хотя значительная часть общин Асатру в мире существует вне связи с какими-либо
                    ...
                    значительных территориях. Таковы исландская Ásatrúarfélagið, датская Forn Siðr (Asa- og
